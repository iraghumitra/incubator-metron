...
import {MetronTableScrollModule} from '../../shared/metron-table/metron-table-scroll/metron-table-scroll.module';

@NgModule({
    imports: [routing, SharedModule, ConfigureRowsModule, MetronSorterModule, MetronTablePaginationModule,
                ListGroupModule, CollapseModule, MetronTableScrollModule],
    exports: [],
